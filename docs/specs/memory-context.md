...
Когда рабочий контекст перевалил за 8000 токенов (~16000 символов кириллицей, ~7-8 раундов игры). Считаем через tiktoken или эвристику (~2 символа на токен для кириллицы).
