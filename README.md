...
### Вариант 1: Docker (без установки Python)
...
# Интерактивная игра
docker run -it -e OPENROUTER_API_KEY=sk-or-... party-of-one party_of_one.play

# Watch mode (AI играет сама, 10 раундов)
docker run -e OPENROUTER_API_KEY=sk-or-... party-of-one party_of_one.eval \
  --mode watch --rounds 10 \
